 ...
 */
public class EventLogger implements EasyExoPlayer.Listener, EasyExoPlayer.InfoListener,
        EasyExoPlayer.InternalErrorListener {
    ...
    public EventLogger() {
        loadStartTimeMs = new long[EasyExoPlayer.RENDERER_COUNT];
    }
