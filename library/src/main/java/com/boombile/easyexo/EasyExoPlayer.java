 ...
 */
public class EasyExoPlayer implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
    ...
    public interface RendererBuilder {
         ...
         *
         * @param player The player for which renderers are being built. {@link EasyExoPlayer#onRenderers}
         *               should be invoked once the renderers have been built. If building fails,
         *               {@link EasyExoPlayer#onRenderersError} should be invoked.
         */
        void buildRenderers(EasyExoPlayer player);

        /**
         * Cancels the current build operation, if there is one. Else does nothing.
         * <p/>
         * A canceled build operation must not invoke {@link EasyExoPlayer#onRenderers} or
         * {@link EasyExoPlayer#onRenderersError} on the player, which may have been released.
         */
        void cancel();
    }
    ...
    public EasyExoPlayer(RendererBuilder rendererBuilder) {
     ...
     *
     * @param trackNames        The names of the available tracks, indexed by {@link EasyExoPlayer} TYPE_*
     ...
     *                          indexed by {@link EasyExoPlayer} TYPE_* constants. May be null if there are no types with
     *                          multiple tracks. An individual element may be null if it does not have multiple tracks.
     * @param renderers         Renderers indexed by {@link EasyExoPlayer} TYPE_* constants. An individual
