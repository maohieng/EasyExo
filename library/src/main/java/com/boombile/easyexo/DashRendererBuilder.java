...
/**
 * A {@link EasyExoPlayer.RendererBuilder} for DASH.
 */
public class DashRendererBuilder implements EasyExoPlayer.RendererBuilder {
  ...
  @Override
  public void buildRenderers(EasyExoPlayer player) {
  ...
  private static final class AsyncRendererBuilder
    ...
    private final MediaDrmCallback drmCallback;
    private final AudioCapabilities audioCapabilities;
    private final EasyExoPlayer player;
    ...
    public AsyncRendererBuilder(Context context, String userAgent, String url,
        MediaDrmCallback drmCallback, AudioCapabilities audioCapabilities, EasyExoPlayer player) {
      this.context = context;
      this.userAgent = userAgent;
      this.drmCallback = drmCallback;
      this.audioCapabilities = audioCapabilities;
    ...
    private void buildRenderers() {
      ...
      if (textChunkSourceList.isEmpty()) {
        ...
        SampleSource textSampleSource = new ChunkSampleSource(textChunkSource, loadControl,
            ...
            EasyExoPlayer.TYPE_TEXT);
        textRenderer = new TextTrackRenderer(textSampleSource, player, mainHandler.getLooper(),
            new TtmlParser(), new WebvttParser());
      }

      // Invoke the callback.
      String[][] trackNames = new String[EasyExoPlayer.RENDERER_COUNT][];
      trackNames[EasyExoPlayer.TYPE_AUDIO] = audioTrackNames;
      trackNames[EasyExoPlayer.TYPE_TEXT] = textTrackNames;

      MultiTrackChunkSource[] multiTrackChunkSources =
          new MultiTrackChunkSource[EasyExoPlayer.RENDERER_COUNT];
      multiTrackChunkSources[EasyExoPlayer.TYPE_AUDIO] = audioChunkSource;
      multiTrackChunkSources[EasyExoPlayer.TYPE_TEXT] = textChunkSource;

      TrackRenderer[] renderers = new TrackRenderer[EasyExoPlayer.RENDERER_COUNT];
      renderers[EasyExoPlayer.TYPE_VIDEO] = videoRenderer;
      renderers[EasyExoPlayer.TYPE_AUDIO] = audioRenderer;
      renderers[EasyExoPlayer.TYPE_TEXT] = textRenderer;
